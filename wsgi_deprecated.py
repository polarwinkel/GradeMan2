...
#coding: utf-8
'''
WSGI-Wrapper of GradeMan2

credits:
copied from:
https://github.com/sintrb/SVNOnline/blob/master/SVNOnline/wsgi.py
'''

import os
import wsgiref.util
from GradeMan import HTTPServer_RequestHandler
...
class WSGIHandler(HTTPServer_RequestHandler):
    path = None
    headers = None
...
#use gunicorn -b 0.0.0.0:8000 wsgi:application to test it.
